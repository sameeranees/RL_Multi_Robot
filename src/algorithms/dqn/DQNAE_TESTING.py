...
class Env(Node):
    ...
    def __init__(self):
        ...
        self.asset_path = 'omniverse://localhost/Projects/ISAAC MATERIAL/Collected_Thesis_3/Thesis1.usd'
    ...
    def step(self, action):
        ...
        reward = self.get_reward(target, collision, action, min_laser,repetitive_behavior)
    ...
    @staticmethod
    def get_reward(target, collision, action, min_laser,repetitive_behavior):
...
if __name__ == '__main__':
    ...
    outdir = './testing_results/dqlearn'
    path = './testing_results/dqlearn/turtle_c2_dqn_ep'
    ...
    try:
        ...
        for epoch in range(current_epoch + 1, epochs + 1, 1):
            ...
            while not done and episode_step <= steps:
                ...
                explorationRate = max(0.05, explorationRate * epsilon_discount)
